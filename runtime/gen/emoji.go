...
const (
	...
	headerComment   = "// Code generated by runtime/gen. DO NOT EDIT.\n"
...
func genEmoji() {
	...
	writeOutput(filepath.Base(pngFile), index, fallbackRect, len(index), maxSeq, sheetW, sheetH, maxHeight, maxWidth)
}
...
func writeOutput(pngFileName string, index map[string]image.Rectangle, fallback image.Rectangle, count, maxSeq, sheetW, sheetH, maxHeight, maxWidth int) {
	var b bytes.Buffer
